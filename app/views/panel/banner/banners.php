    ...
    <div class="m-4">
        ...
        <form action="<?=$this->base_url;?>" method="post">
            ...
            <table class="table" role="table">
                ...
                <tbody role="rowgroup">
                <?php foreach ($banners['data'] as $key => $row) { ?>
                    <tr role="row">
                        ...
                        <td role="cell" data-label="">
                            ...
                            ?>     
                            <a href="panel/banner/status/<?=$row['id'];?>" title="<?=$title;?>" class="btn btn-sm btn-<?=$class;?> rounded-0">
                                <i class="bi bi-<?=$icon;?>"></i>
                            </a>

                            <a href="panel/banner/edit/<?=$row['id'];?>" class="btn btn-sm btn-primary rounded-0">
                                <i class="bi bi-pencil-square"></i>
                            </a>
                            
                            <a onclick="return confirm('Are you sure you want to delete?')" href="panel/banner/remove/<?=$row['id'];?>" class="btn btn-sm btn-danger rounded-0">
            ...
            <?php if(empty($banners['data'])){
                echo '<h4>There are no ads yet.</h4>';
            } ?>
